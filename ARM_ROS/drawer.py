...
arm_time_m = [i for i in arm_time]
...
# fig = go.Figure()
# fig.add_traces(go.Scatter(x=arm_time, y = arm_pos_q1, mode = 'lines', line=dict(color=colors[0])))
# fig.add_traces(go.Scatter(x=kuka_time, y = kuka_pos_q1, mode = 'lines', line=dict(color=colors[1])))
