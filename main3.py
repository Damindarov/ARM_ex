...
if __name__ == '__main__':
    ...
    while True:
        ...
        Kd = 0.54
        Ki = 2.0
        if time_step_start - time_step_finish < 1:
            Proportionial = Kp * err
            Integral = Integral + Ki * err * (time_step_start - time_step_finish)
            Differ = Kd * (err - e_prev)/(time_step_start - time_step_finish)
            valToLittle = (L_Little/-0.085) + 3615
            pwm_little = int(0 - Proportionial - Differ - Integral)
